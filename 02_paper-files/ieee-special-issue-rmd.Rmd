...
speed_p <- speed_tab |>
  ...
  mutate(
    `Demo Group` = factor(`Demo Group`, 
                  levels = c("18-29", "30-44", "45-59", "60+","Less than HS",  "HS graduate or equiv", "Some college/\n associates degree", "Bachelor's degree", "Post grad study/\nprofessional degree",  "Male", "Female", "Less than $30k", "$30k to under $60k", "$60k to under $100k", "$100k or more", "White, non-Hispanic", "Hispanic", "Black, non-Hispanic", "Other, non-Hispanic"))
  ) |>
  ggplot() + 
...
itemaccuracy_p_dat <- bind_rows(model_IS1_coefs,
  ...
  mutate(demographic = factor(demographic, levels = c("(Intercept)", "Design", "speederISitems", "Device", "Education", "Income", "Age", "Gender", "Race/Ethnicity"))) |>
    ...
    category = factor(category, 
                  levels = c("(Intercept)",  "Line", "Diverging Stacked Bar", "speeder", "Tablet, Smartphone, or Other", "HS graduate or equivalent", "Some college/ associates degree",  "Bachelor's degree",  "Post grad study/professional degree", "$30,000 to under $60,000", "$60,000 to under $100,000", "$100,000 or more","30-44", "45-59", "60+", "Female", "White, non-Hispanic", "Hispanic", "Black, non-Hispanic"))
  ) 
