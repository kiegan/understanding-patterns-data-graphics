...
**Author response:** *There is not evidence to support that the Börner et al. paper represents a diverse audience as the study only reports perceived sex of participants and whether participants were youth or adults. That said, we agree that both mentioned studies provide an important view of oft-understudied groups in the literature and have added a sentence in the paper's introduction to call out these prior contributions and better situate our work among them.*

Minor:  


1. Consider accounting for rior data visualization experience: The study does not account for participants' prior exposure to or familiarity with data visualizations, which could significantly influence their performance and interpretation skills.
